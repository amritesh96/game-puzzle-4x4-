...
<head>
  ...
  <meta name="description" content="Fifteen Puzzle game (15 puzzle-game): move tiles in grid to order them from 1 to 15!">
  <meta name="keywords" content="Fifteen puzzle, game, fifteen puzzle, game, tile">
  <meta name="author" content="Lorenzo Cioni">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="Robots" content="All" />
  
  
  <script src="${pageContext.request.contextPath}/resources/lib/jquery-2.1.1.min.js"></script>
  <script src="${pageContext.request.contextPath}/resources/lib/jquery.touchSwipe.min.js"></script>
  <script src="${pageContext.request.contextPath}/resources/js/Mtiles.js"></script>
  <script src="${pageContext.request.contextPath}/resources/js/Mmain.js"></script>
